  ...
  const tvcProjects = [
    {
      ...
      subtitle: 'AI Podcast Style Commercial',
      description: 'Engaging product visualization structured as a dynamic AI-generated podcast snippet.',
      icon: TvMinimal,
      badge: 'Product Commercial',
      isHLS: false,
    },
    {
      src: '/videos/Player Montage Edit (Mohamed Salah).mp4',
      title: 'Sports Action Montage',
      subtitle: 'Dynamic Athlete Feature',
      description: 'High-energy player montage featuring Mohamed Salah with premium motion graphics and seamless transitions.',
      icon: Award,
      badge: 'Sports Edit',
      isHLS: false,
    },
    {
      ...
      subtitle: 'Urban Visual Storytelling',
      description: 'Cinematic portrayal of Mumbai combining traditional camera work with AI-enhanced visual elements.',
      icon: Sparkles,
